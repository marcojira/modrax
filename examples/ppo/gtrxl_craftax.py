...
from modrax.env import CraftaxConfig, Env
...
class CraftaxGTrXLNetworkConfig(NetworkConfig):
    encoder_dim: int = 256
...
def main():
    env_config = CraftaxConfig(env_name="Craftax-Symbolic-v1", optimistic_reset=True)
    network_config = CraftaxGTrXLNetworkConfig()
